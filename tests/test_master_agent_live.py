...
assert body["agent_status"]["delegate_to"] == "talking_head_video_agent", body
saved = server.load_conversation(cid)
run = saved["agent_runs"]["talking-head-prod_1"]
assert run["awaiting"] == "confirmation", run
