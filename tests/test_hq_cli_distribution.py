...
RELEASE = ROOT / "site/downloads/hq/v0.2.0"
WHEEL = RELEASE / "huangque_hq_cli-0.2.0-py3-none-any.whl"
...
class HQCLIDistributionTests(unittest.TestCase):
    def test_release_checksum_and_installer_are_pinned(self):
        ...
        self.assertIn('wheel_url="https://huangquechuanmei.com/downloads/hq/v0.2.0/$wheel_name"', source)
