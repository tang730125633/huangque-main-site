...
async function scenarioLockedFont(){
  ...
  return {body:JSON.parse(runtime.requests.post[0].options.body),disabled:runtime.get('fontFamily').disabled,value:runtime.get('fontFamily').value,source:runtime.get('fontSource').textContent};
}
