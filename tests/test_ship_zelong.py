...
class ZelongDeploymentSafetyTests(unittest.TestCase):
    ...
    def test_only_expected_huangque_services_can_restart(self):
        ...
        self.assertEqual({"huangque-auth", "huangque-content", "huangque-imggen-api",
                          "huangque-leadgen-api", "hermes-ip12-preview"}, set(restarts))
    ...
    def test_health_checks_wait_through_the_service_startup_window(self):
        ...
        self.assertEqual(13, SRC.count(retry_options))
    ...
    def test_ip12_preview_preset_is_isolated_and_complete(self):
        ...
        self.assertIn('HERMES_PREVIEW_MODEL:-gpt-5.6-terra', preview_runner)
        self.assertIn('OPENAI_API_KEY', preview_runner)
        self.assertIn('HERMES_PREVIEW_HTTPS_PROXY:-http://127.0.0.1:10810', preview_runner)
        self.assertIn('HERMES_PREVIEW_NO_PROXY:-127.0.0.1,localhost,::1', preview_runner)
        self.assertIn('HERMES_PREVIEW_COGNITIVE_ENGINE:-custom', preview_runner)
        ...
        self.assertIn("InputTokensDetails(cached_tokens=0)", preview_runner)
