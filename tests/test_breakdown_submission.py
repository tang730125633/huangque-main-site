...
class CopyProviderFallbackTests(unittest.TestCase):
    def test_copy_uses_configured_chat_completions_channel(self):
        with mock.patch.multiple(text, COPY_API_STYLE="chat_completions",
                                 COPY_BASE="https://api.openai.com",
