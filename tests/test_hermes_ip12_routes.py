...
'''
        ...
        self.assertIn("item.type==='open_voice_clone'", page)
        ...
        self.assertIn("function renderVoiceCloneReady", page)
        self.assertIn("if(voiceCloneUi.status==='complete'){restoreCompleteVoiceClone()", page)
        self.assertIn("我的个人音色')+' · 已就绪", page)
        self.assertIn("setTimeout(collapseVoiceCloneReady,8000)", page)
        self.assertNotIn("setTimeout(dismissVoiceCloneResult,8000)", page)
        self.assertNotIn("if(voiceCloneUi.status==='complete'){dismissVoiceCloneResult()", page)
