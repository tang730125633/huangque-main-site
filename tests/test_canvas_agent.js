...
assert.ok(app.includes("'Idempotency-Key':imageSubmissionKey"));
assert.ok(app.includes("'Idempotency-Key':videoSubmissionKey"));
assert.ok(app.includes("duration:Number(node.params.duration||5)"));
