...
- 目标分支：`main`
- 阶段一基线：`main@c79326accff4595bbe5c60b37287290c0f52bde9`
- 业务/Schema SHA：`d179e531e99adef3d66d95a21ce603d190567958`
- 阶段一合成候选：`d89214dbddc6a989d3a49aadf9d40ceeab763228`
...
LU-003 于 2026-09-15 给出的当前阶段一批准原文：

> 我以 LU-003 负责人身份重新批准 PR 1564 业务/Schema SHA
> `d179e531e99adef3d66d95a21ce603d190567958`，基于
> `main@c79326accff4595bbe5c60b37287290c0f52bde9`，沿用既定维护窗口、数据库路径、停写、
> WAL 一致性备份、三张新表及索引的幂等迁移、升级验证和失败回滚方案；授权更新版本化治理
> 记录并发布到 PR。本批准取代旧阶段一批准，不授权部署、真实 Provider 调用或数据库整体恢复。

此前基于 `main@b620e50c4fc956c9ae5076db23c26ae313ef7911` 对同一业务/Schema SHA 的
阶段一批准因主线前进失效；更早针对 `08ee6786f04600163f87af8c57253b0e189900b4`
及 `main@aac1934ba2612cc76b1d4d2eaa3640c9495f5d90` 的批准也已失效，仅保留在 PR 评论
审计历史中。业务代码、Schema、数据库路径、维护窗口、目标分支或基线再次变化时，当前批准
立即失效，必须重新固定、验证和批准。
