(function(){
  ...
  function render(){
    ...
    if(current){
      ...
      host.querySelector('#cpRefHint').textContent=current.reference_max?'参考图 '+current.reference_min+'～'+current.reference_max+' 张，总大小不超过8MB。':'当前模型为文生图模式，无需参考图。';
