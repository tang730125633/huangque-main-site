...
(function () {
  ...
  var D = {
    ...
    uptime: '<circle cx="12" cy="13" r="8" ' + L + '/><path d="M12 9v5l3 2M9 2h6" ' + A + '/>',
    os: '<rect x="3" y="4" width="18" height="16" rx="2" ' + L + '/><path d="M3 9h18M7 6.5h.01M10 6.5h.01M8 14l2 2-2 2M13 18h3" ' + A + '/>',
