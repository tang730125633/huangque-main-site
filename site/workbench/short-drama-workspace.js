(function(root,factory){
  ...
  function mount(doc,options){
    ...
    function renderShotModal(){
      ...
      var draft=readShotDraft(shot.shot_key),persistedDialogues=lines.filter(function(line){return line.kind!=='silence'&&text(line.text).trim();}).map(function(line){return {id:line.id||'',kind:line.kind||'dialogue',character_key:line.character_key||'',text:line.text||'',speech_rate:Number(line.speech_rate)||1};});
