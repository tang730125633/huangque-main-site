...
_SEMANTIC_LAYER_TRANSITIONS = {
    ...
    (NINE_GRID_VARIANT, "bottom2"): {
        (58, 900, 930, 4),
        (58, 900, 930, 10),
    },
    (TRIPLE_STRIP_VARIANT, "top2"): {
        (38, 900, 738, 3),
        (50, 900, 738, 6),
    },
    (TRIPLE_STRIP_VARIANT, "bottom2"): {
        (26, 750, 620, 4),
        (50, 750, 620, 10),
    },
    (YELLOW_BANNER_VARIANT, "top2"): {
        (38, 900, 900, 2),
        (50, 900, 900, 2),
    },
    (YELLOW_BANNER_VARIANT, "top3"): {
        (38, 900, 900, 2),
        (50, 900, 900, 2),
    },
    (YELLOW_BANNER_VARIANT, "bottom2"): {
        (32, 750, 787, 4),
        (50, 750, 787, 5),
    },
    (FAN_WHIP_VARIANT, "top2"): {
        (46, 900, 996, 2),
        (50, 900, 996, 2),
    },
    (FAN_WHIP_VARIANT, "top3"): {
        (38, 900, 996, 2),
        (50, 900, 996, 2),
    },
    (FAN_WHIP_VARIANT, "bottom2"): {
        (42, 900, 996, 4),
        (50, 900, 996, 5),
    },
    (BRUSH_PANEL_VARIANT, "top2"): {
        (46, 900, 996, 2),
        (50, 900, 996, 2),
    },
    (BRUSH_PANEL_VARIANT, "top3"): {
        (38, 900, 996, 2),
        (50, 900, 996, 2),
    },
    (BRUSH_PANEL_VARIANT, "bottom2"): {
        (42, 900, 996, 4),
        (50, 900, 996, 5),
    },
    ("v04", "bottom2"): {
