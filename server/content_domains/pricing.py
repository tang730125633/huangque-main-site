...
CATALOG = [
    ...
    _rule("video.timeline_compose.base", "视频生成", "时间轴拼接成片", "基础费", 5, "点/条"),
    _rule("video.timeline_compose.segment", "视频生成", "时间轴拼接成片", "素材段", 1, "点/段"),
    _rule("video.timeline_compose.30s", "视频生成", "时间轴拼接成片", "每 30 秒，不足按 30 秒", 2, "点/30秒"),
