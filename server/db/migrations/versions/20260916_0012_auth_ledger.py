...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("note", sa.Text(), nullable=False, server_default=sa.text("''"),
                  comment="赠送附言，用户可见"),
        sa.Column("sender_before", sa.Integer(), nullable=False,
                  comment="赠送方转出前余额快照"),
        sa.Column("sender_after", sa.Integer(), nullable=False,
                  comment="赠送方转出后余额快照，必须等于 sender_before - amount"),
        sa.Column("recipient_before", sa.Integer(), nullable=False,
                  comment="接收方转入前余额快照"),
        sa.Column("recipient_after", sa.Integer(), nullable=False,
    ...
    op.create_table(
        ...
        sa.Column("reward_total_after", sa.Integer(), nullable=False,
    ...
    op.create_table(
        ...
        sa.Column("discount_bps", sa.Integer(), nullable=False, server_default=sa.text("10000"),
