...
- 用户开始输入后自动收起精简 Hero，并优先使用消息区可压缩空间限制输入框增长；900p/1080p 的能力面板保持完整无内滚，860px 及以下矮屏允许能力区按需滚动，清空输入可恢复 Hero。
...
补丁 SHA-256：`d876757ad04d7a07e3ad167d8f5b76525243ff36d790067fec35585cd92dc938`

预期结果树：`af9fe1e3cea465e2919c2f71e281ba253c8d7260`
...
- 800、801、830、860 与 861px 的断点邻近高度均保持输入框可见、能力卡可达，最多只有能力区成为实际滚动容器。
...
test "$(git write-tree)" = "af9fe1e3cea465e2919c2f71e281ba253c8d7260"
```
