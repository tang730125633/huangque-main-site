...
ASSETS = (
    ...
    Asset("digital-human-recovery.js", required=False),
    Asset("digital-human-material-state.js", required=False),
    Asset("digital-human-voice-state.js", required=False),
    Asset("digital-human-setup-state.js", required=False),
    Asset("digital-human-oneclick-state.js", required=False),
    Asset("digital-human-submit.js", required=False),
    Asset("digital-human-preflight.js", required=False),
    ...
    Asset("video-agent-canvas.js", required=False),
    Asset("video-agent-session.js", required=False),
    Asset("video-agent-routing.js", required=False),
...
SITE_ASSETS = (
    *(SiteAsset("admin/" + name, "/admin/" + name, ("admin/index.html",))
      for name in ("channel-manager.js", "channel-catalog.js", "channel-workspace.js", "channel-provider-config.js",
